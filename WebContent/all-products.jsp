...
<body>
					...
					<input type="submit" value="Go!">
 					...
 					<%ArrayList<Product> list =(ArrayList<Product>)session.getAttribute("list");  
 						  ...
 						  %>
		 					...
		 					<div class="col-md-4">
		 						<img alt="error" src="<%=p.getImage() %>" class="img-responsive" style="width:70%;" ><br>
		 						...
		 						<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=allproducts&id=<%=p.getId()%>">Add to Cart</a> </div><br>
		 					</div>
	...
	<footer>
		<div class="footer bg-dark" style="margin-bottom:0px;"> &copy; 2019 Copyright:
