					...
					<input type="submit" value="Go!">
 					...
 					<%ArrayList<Product> list =(ArrayList<Product>)session.getAttribute("list");  
 						  for(Product p:list)
 						  {
 							...
 							if(p.getCategory().equals("mobiles"))
 							{
 						  %>
		 					...
		 					<div class="col-md-4">
		 						...
		 						<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=mobiles&id=<%=p.getId()%>">Add to Cart</a> </div><br>
		 					</div>
